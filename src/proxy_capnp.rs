  ...
  pub mod make_thread_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 35] = [
        ...
        ::capnp::word(114, 111, 120, 121, 46, 99, 97, 112),
        ::capnp::word(110, 112, 58, 84, 104, 114, 101, 97),
        ::capnp::word(100, 77, 97, 112, 46, 109, 97, 107),
        ::capnp::word(101, 84, 104, 114, 101, 97, 100, 36),
  ...
  pub mod get_name_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 19] = [
        ...
        ::capnp::word(114, 111, 120, 121, 46, 99, 97, 112),
        ::capnp::word(110, 112, 58, 84, 104, 114, 101, 97),
        ::capnp::word(100, 46, 103, 101, 116, 78, 97, 109),
...
pub mod context {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 58] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(231, 8, 0, 0, 109, 10, 0, 0),
