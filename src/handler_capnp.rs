  ...
  pub mod destroy_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 35] = [
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(115, 99, 104, 101, 109, 97, 47, 104),
        ::capnp::word(97, 110, 100, 108, 101, 114, 46, 99),
        ::capnp::word(97, 112, 110, 112, 58, 72, 97, 110),
        ::capnp::word(100, 108, 101, 114, 46, 100, 101, 115),
  ...
  pub mod disconnect_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 35] = [
        ...
        ::capnp::word(97, 110, 100, 108, 101, 114, 46, 99),
        ::capnp::word(97, 112, 110, 112, 58, 72, 97, 110),
        ::capnp::word(100, 108, 101, 114, 46, 100, 105, 115),
        ::capnp::word(99, 111, 110, 110, 101, 99, 116, 36),
