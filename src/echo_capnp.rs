...
// DO NOT EDIT.
// source: schema/echo.capnp



pub mod echo {
  #![allow(unused_variables)]
  pub type DestroyParams<> = ::capnp::capability::Params<crate::echo_capnp::echo::destroy_params::Owned>;
  pub type DestroyResults<> = ::capnp::capability::Results<crate::echo_capnp::echo::destroy_results::Owned>;
  pub type EchoParams<> = ::capnp::capability::Params<crate::echo_capnp::echo::echo_params::Owned>;
  pub type EchoResults<> = ::capnp::capability::Results<crate::echo_capnp::echo::echo_results::Owned>;
  ...
  impl  Client {
    pub fn destroy_request(&self) -> ::capnp::capability::Request<crate::echo_capnp::echo::destroy_params::Owned,crate::echo_capnp::echo::destroy_results::Owned> {
      self.client.new_call(_private::TYPE_ID, 0, ::core::option::Option::None)
    }
    pub fn echo_request(&self) -> ::capnp::capability::Request<crate::echo_capnp::echo::echo_params::Owned,crate::echo_capnp::echo::echo_results::Owned> {
      self.client.new_call(_private::TYPE_ID, 1, ::core::option::Option::None)
    }
  }
  pub trait Server<>   {
    fn destroy(&mut self, _: DestroyParams<>, _: DestroyResults<>) -> ::capnp::capability::Promise<(), ::capnp::Error> { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("method echo::Server::destroy not implemented".to_string())) }
    fn echo(&mut self, _: EchoParams<>, _: EchoResults<>) -> ::capnp::capability::Promise<(), ::capnp::Error> { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("method echo::Server::echo not implemented".to_string())) }
  }
  ...
  impl <_T :Server> ServerDispatch<_T> {
    pub fn dispatch_call_internal(server: &mut _T, method_id: u16, params: ::capnp::capability::Params<::capnp::any_pointer::Owned>, results: ::capnp::capability::Results<::capnp::any_pointer::Owned>) -> ::capnp::capability::DispatchCallResult {
      match method_id {
        ...
        1 => ::capnp::capability::DispatchCallResult::new(server.echo(::capnp::private::capability::internal_get_typed_params(params), ::capnp::private::capability::internal_get_typed_results(results)), false),
        _ => { ::capnp::capability::DispatchCallResult::new(::capnp::capability::Promise::err(::capnp::Error::unimplemented("Method not implemented.".to_string())), false) }
      }
    }
  }
  pub mod _private {
    pub const TYPE_ID: u64 = 0xd36b_8964_0dc9_4399;
  }
  ...
  pub mod destroy_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 34] = [
        ...
        ::capnp::word(133, 251, 93, 182, 76, 47, 111, 185),
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(115, 99, 104, 101, 109, 97, 47, 101),
        ::capnp::word(99, 104, 111, 46, 99, 97, 112, 110),
        ::capnp::word(112, 58, 69, 99, 104, 111, 46, 100),
      ...
      pub const TYPE_ID: u64 = 0xb96f_2f4c_b65d_fb85;
    }
  }
  ...
  pub mod destroy_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 18] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(255, 138, 134, 141, 211, 215, 62, 180),
        ::capnp::word(23, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      pub const TYPE_ID: u64 = 0xb43e_d7d3_8d86_8aff;
    }
  }
  ...
  pub mod echo_params {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_echo(self) -> ::capnp::Result<::capnp::text::Reader<'a>> {
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn get_echo(self) -> ::capnp::Result<::capnp::text::Builder<'a>> {
        ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
      }
      #[inline]
      pub fn set_echo(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
        ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false).unwrap()
      }
      #[inline]
      pub fn init_echo(self, size: u32) -> ::capnp::text::Builder<'a> {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 49] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(14, 189, 76, 194, 6, 128, 184, 198),
        ::capnp::word(23, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        ::capnp::word(115, 99, 104, 101, 109, 97, 47, 101),
        ::capnp::word(99, 104, 111, 46, 99, 97, 112, 110),
        ::capnp::word(112, 58, 69, 99, 104, 111, 46, 101),
      ...
      pub const TYPE_ID: u64 = 0xc6b8_8006_c24c_bd0e;
    }
  }
  ...
  pub mod echo_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 34] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(49, 19, 91, 216, 217, 191, 107, 157),
        ::capnp::word(23, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub static MEMBERS_BY_NAME : &[u16] = &[0];
      pub const TYPE_ID: u64 = 0x9d6b_bfd9_d85b_1331;
    }
  }
}
